	...
	<div class="login-form">
		...
		<div class="login-content">
			...
			<div class="form-login-error">
				<h3>Invalid login</h3>
				<p>Please enter correct email and password!
				</p>
			</div>
			<div><p>
				<?php if(isset($_SESSION['password_set']) && $_SESSION['password_set']=="success"){
					echo "<p class='text-success'>Successful setup! you can now login</p>";
					}
					if(isset($_SESSION['password_set']) && $_SESSION['password_set']=="failed"){
						echo "<p class='text-danger'>Setup Failed! you cant now login</p>";
						}
					?>
				</p></div>
