...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      ...
      <ul class="breadcrumb">
                <li><a href="">Home</a></li>
                <li><a href="">Pending Activations</a></li>
              </ul>
    </div>
  </div>
  <div class="container-fluid">
      ...
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-list"></i> Pending Activations List</h3>
      </div>
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <?php foreach($pending_activations as $act): ?>
                  ...
                  <td class="text-left"><?php echo isset($act->service_name)?$act->service_name:'Service Not set' ?></td>
                  ...
                  <td class="text-right"><a class="btn btn-success" title="Activate Now"  onclick="showAjaxModal('<?php echo base_url().'modal/popup/modal_activate/'.$act->userID ?>');">Activate Now</button></a>
                </tr>
          <?php endforeach; ?>
