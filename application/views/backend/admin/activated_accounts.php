...
<div id="content">
  ...
  <div class="container-fluid">
      ...
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-list"></i> Active accounts List</h3>
      </div>
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <?php foreach($pending_activations as $act): ?>
                  ...
                  <td class="text-right"><a class="btn btn-info" title="Activate Now" onclick="showAjaxModal('<?php echo base_url('modal/popup/modal_download_docs/'.$act->userID ) ?>');">Download/View</a></td>
                  <td class="text-right"><a class="btn btn-danger" title="Ban Now"  onclick="showAjaxModal('<?php echo base_url('modal/popup/modal_block_now/'.$act->userID )?>');">Block Now</button></a>
