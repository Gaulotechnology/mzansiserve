...
<?php } ?>
  ...
  <div class="container-fluid">        <div class="row">
          ...
          if(isset($services[0]->profession_name)){  ?>
      ...
      <div class="col-md-12 col-sm-12">
        <div class="panel panel-default">
              ...
              <div class="table-responsive">
                <table class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <td class="text-left"><?php echo $prod->profession_name ?></td>
          ...
          <div class="panel-heading">
            ...
            <form action="<?php echo base_url() ?>page/manage_profession/update" method="post" enctype="multipart/form-data" id="form-product">
              <div class="table-responsive">
                <table class="table bordered table-hover">
                 <thead>
                 <tr>
                 <tr><td>Title</td><td><input type="text" class="form-control" value="<?php echo $prod->title ?>" name="title"></td><td>
                 </tr>
                 <tr><td>Description</td><td>
               
                 <textarea class="form-control" name="description"><?php echo $prod->description ?></textarea>
                 <input type="hidden" name="profession_id" id="profession_id" value="<?php echo $prod->profession_id ?>">
                 <input type="hidden" name="user_id" id="provider" value="<?php echo  $user_id ?>">
                 <input type="hidden" name="pID"  value="<?php echo $prod->pID  ?>">
                
                 </td></tr>

                 <tr><td>Additional Skills</td><td>
                 <textarea class="form-control" name="skills"><?php echo $prod->skills ?></textarea>
                 </td></tr>
                 <tr><td>Add Images</td><td>
                 <input type="file" class="form-control" name="pofession_image[]" multiple/>
                 </thead>
