<?php 
$edit_data		=	$this->db->get_where('users' , array('user_id' => $param2) )->result_array();
		...
		<div class="panel panel-primary" data-collapsed="0">
        	<div class="panel-heading">
            	<div class="panel-title" >
					...
					<?php echo "Edit User";//get_phrase('edit_teacher');?>
            	</div>
            </div>
			<div class="panel-body">
                    <?php echo form_open(base_url() . 'users/do_update/'.$row['user_id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo "level";//get_phrase('birthday');?></label>
                                <div class="col-sm-5">
