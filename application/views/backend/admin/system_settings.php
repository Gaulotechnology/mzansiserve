<hr />
    ...
    <div class="row">
    <?php echo form_open(base_url() . 'page/system_settings/do_update' , 
      ...
      ?>
        ...
        <div class="col-md-6">
            ...
            <?php echo form_open(base_url() . 'page/system_settings/upload_logo' , array(
...
<script type="text/javascript">
    $(".gallery-env").on('click', 'a', function () {
        skin = this.id;
        $.ajax({
            url: '<?php echo base_url();?>page/system_settings/change_skin/'+ skin,
            success: window.location = '<?php echo base_url();?>page/system_settings/'
        });
});
</script>