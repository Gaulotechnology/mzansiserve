...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="tab-content">
            <!----EDITING FORM STARTS---->
            <div class="tab-pane active" id="list" style="padding: 5px">
                <div class="box-content">
                    ...
                    foreach($edit_data as $row){
                        ...
                        ?>
                        <?php echo form_open(base_url() . 'page/manage_profile/update_profile_info' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top' , 'enctype' => 'multipart/form-data'));?>
              ...
              <i class="fa fa-plus"></i></button>
                 ...
                 <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="date" class="form-control" name="dob" value="<?php echo $docs->dob ?>" required />
                                </div>
                            </div>
                            <div class="form-group">
...
<div class="form-group">
                ...
                <i class="fa fa-plus"></i></button>
                 ...
                 <?php if($role>2){ ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                  <textarea name="work_address" class="form-control"><?php echo $docs->work_address ?>
                                </textarea>
                                </div>
                            </div>
                            <div class="form-group">
                ...
                <div class="box collapsed-box">
                 <div class="box-header with-border">
                <h3 class="box-title">Car/Driver Details</h3>
              ...
              <i class="fa fa-plus"></i></button>
                 ...
                 <div class="box-body">
                         ...
                         <div class="box collapsed-box">
                        <div class="box-header with-border">
                         <h3 class="box-title">Professional Service Details</h3>
                        ...
                        <!-- Service Provider Details Box -->
                        <div class="box collapsed-box">
                        <div class="box-header with-border">
                         <h3 class="box-title">Service Provider Details</h3>
