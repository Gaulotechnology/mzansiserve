<div class="row">
	<div class="col-md-12 col-sm-12 clearfix" style="text-align:center;">
		<h2 style="font-weight:200; margin:0px;">MZANSI SERVE BACKEND</h2>
    </div>
	<!-- Raw Links -->
	<div class="col-md-12 col-sm-12 clearfix ">
		...
		<ul class="list-inline links-list pull-right">
           ...
           <li class="dropdown language-selector">
			...
			<li><a href="<?php echo base_url();?>index.php?page/change_password">
					Change Password <i class="entypo-eye right"></i>
				</a> | 
