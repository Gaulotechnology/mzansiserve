				...
				<div class="container">
					...
					<div class="happy-clients-grids">
						<div class="col-md-6 happy-clients-grid wow bounceIn" data-wow-delay="0.4s">
							<div class="client">
								<img src="<?php echo base_url() ?>assets/homepage/images/client_1.jpg" alt="" />
							</div>
							<div class="client-info">
								<p><img src="<?php echo base_url() ?>assets/homepage/images/open-quatation.jpg" class="open" alt="" />Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make.<img src="<?php echo base_url() ?>assets/homepage/images/close-quatation.jpg" class="closeq" alt="" /></p>
						...
						<div class="col-md-6 happy-clients-grid span_66 wow bounceIn" data-wow-delay="0.4s">
							<div class="client">
								<img src="<?php echo base_url() ?>assets/homepage/images/client_2.jpg" alt="" />
							</div>
							<div class="client-info">
								<p><img src="<?php echo base_url() ?>assets/homepage/images/open-quatation.jpg" class="open" alt="" />Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.<img src="<?php echo base_url() ?>assets/homepage/images/close-quatation.jpg" class="closeq" alt="" /></p>
						...
						<div class="col-md-6 happy-clients-grid wow bounceIn" data-wow-delay="0.4s">
							<div class="client">
								<img src="<?php echo base_url() ?>assets/homepage/images/client_3.jpg" alt="" />
							</div>
							<div class="client-info">
								<p><img src="<?php echo base_url() ?>assets/homepage/images/open-quatation.jpg" class="open" alt="" />Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make.<img src="<?php echo base_url() ?>assets/homepage/images/close-quatation.jpg" class="closeq" alt="" /></p>
						...
						<div class="col-md-6 happy-clients-grid span_66 wow bounceIn" data-wow-delay="0.4s">
							<div class="client">
								<img src="<?php echo base_url() ?>assets/homepage/images/client_4.jpg" alt="" />
							</div>
							<div class="client-info">
								<p><img src="<?php echo base_url() ?>assets/homepage/images/open-quatation.jpg" class="open" alt="" />Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.<img src="<?php echo base_url() ?>assets/homepage/images/close-quatation.jpg" class="closeq" alt="" /></p>
