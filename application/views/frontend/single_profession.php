...
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA2fZA6EQJe-qaGwnWFmEfI9ytECYC-BNY&callback=initMap"></script>
		...
		var maps_array='<?php print_r(json_encode($profession[0])) ?>';
	...
	<div class="single-page main-grid-border">
		<div class="container">
			<ol class="breadcrumb" style="margin-bottom: 5px;">
				...
				<li class="active"><?php echo $profession[0]->service_name; ?></li>
			</ol>
			<div class="product-desc">
				<div class="col-md-7 product-view">
					<h2><?php echo $profession[0]->profession_name; ?></h2>
					<p> <i class="glyphicon glyphicon-map-marker"></i><a href="#"><?php echo $profession[0]->country ?></a>, <a href="#">city</a>| Added at <?php echo date("Y-m-d H:i:s", $profession[0]->ad_date); ?>, Ad ID: <?php echo $profession[0]->provider_id ?></p>
					...
					<div class="product-details">
						<h4>Company : <a href="#"><?php echo $profession[0]->title; ?></a></h4>
						<h4>Views : <strong>150</strong></h4>
						<p><strong>Display </strong>: <?php echo $profession[0]->title; ?></p>
						<p><strong>Summary</strong> : <?php echo $profession[0]->description; ?></p>
            ...
            <div id="map_canvas" style="width: 100%; height: 500px;"></div>
				...
				<p>
					...
					$images=json_decode($profession[0]->profession_images);
				...
				<div class="col-md-5 product-details-grid">
					<div class="item-price">
						...
						<div class="itemtype">
							...
							<h4><?php echo $profession[0]->title; ?></h4>
							<div class="clearfix"></div>
						</div>
					</div>
					<div class="interested text-center">
						<h4>Interested in this service<small> Contact the provider</small></h4>
						<p><i class="glyphicon glyphicon-earphone"></i><?php echo maskPhoneNumber($profession[0]->cellphone); ?></p>
					</div>
						<div class="tips">
